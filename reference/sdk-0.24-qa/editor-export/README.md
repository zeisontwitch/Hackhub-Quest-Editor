...
Evidence-only project for SDK 0.24 in-game verification: native Wi-Fi, HTTP/curl events, and the Timer node delay and calendar modes. Keeps those checks isolated from author-facing feature exposure.
